...
$settings = New-ScheduledTaskSettingsSet -MultipleInstances IgnoreNew -StartWhenAvailable -ExecutionTimeLimit (New-TimeSpan -Days 8) -RestartCount 3 -RestartInterval (New-TimeSpan -Minutes 5)
